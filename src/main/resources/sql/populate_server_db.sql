...
insert into SN_VERSION (SPOTFIRE_VERSION, SCHEMA_VERSION) values ('63.5', '411');

-- Special groups
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED, FIXED)
  values ('19e7e430-9997-11da-fbc4-0010ac110215', 'Everyone', 'SPOTFIRE', 'Everyone', false, true);
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED, FIXED)
  values ('fed6b2b0-a9e1-11da-8ed2-0010ac110222', 'Administrator', 'SPOTFIRE', 'Administrator', false, true);
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED, FIXED)
  values ('a92097e0-07a7-11db-fd44-0010c0a8019b', 'Library Administrator', 'SPOTFIRE', 'Library Administrator', false, true);
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED, FIXED)
  values ('96b90a10-1d4d-11de-283a-00100a64216b', 'Scheduled Updates Users', 'SPOTFIRE', 'Scheduled Updates Users', false, true);
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED, FIXED)
  values ('5071c63a-b6ca-4f37-aeee-b141be843dda', 'Deployment Administrator', 'SPOTFIRE', 'Deployment Administrator', false, true);
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED, FIXED)
  values ('5bd69e2b-6685-4dd6-9858-8990c46c522b', 'Diagnostics Administrator', 'SPOTFIRE', 'Diagnostics Administrator', false, true);
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED, FIXED)
  values ('4dd3fc65-c727-474b-976c-96b807f36bd6', 'Web Player Administrator', 'SPOTFIRE', 'Web Player Administrator', false, true);
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED, FIXED)
  values ('5f1879fa-2cca-4d03-b47b-ef03e55d927e', 'Scheduling and Routing Administrator', 'SPOTFIRE', 'Scheduling and Routing Administrator', false, true);
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED, FIXED)
  values ('6c677f0f-3cbe-4615-85be-8366c7ce3181', 'Script Author', 'SPOTFIRE', 'Script Author', false, true);
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED, FIXED)
  values ('2cbe823f-1507-4b56-a822-621f431ee061', 'Custom Query Author', 'SPOTFIRE', 'Custom Query Author', false, true);
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED, FIXED)
  values ('3bf79f12-1842-41d5-9002-fa1d70ce071c', 'Anonymous User', 'SPOTFIRE', 'Anonymous User', false, true);
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED, FIXED)
  values ('5a544e10-f305-408b-ae0c-a602eec4ed4f', 'System Account', 'SPOTFIRE', 'System Account', false, true);
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED, FIXED)
  values ('6dc28196-994b-45a9-a289-ac1b9dca9208', 'Automation Services Users', 'SPOTFIRE', 'Automation Services Users', false, true);
...
insert into USERS (USER_ID, USER_NAME, DOMAIN_NAME, DISPLAY_NAME, ENABLED, FIXED) 
  values ('6679bcea-758d-4b72-8d50-32dfa6621239', 'guest', 'ANONYMOUS', 'Guest', false, true);
...
insert into USERS (USER_ID, USER_NAME, DOMAIN_NAME, DISPLAY_NAME, ENABLED, FIXED) values 
  ('be1277ba-3c2d-4bbb-b4c5-8096c4961e51','nodemanager','SPOTFIRESYSTEM', 'Node Manager System Account', true, true);
...
insert into USERS (USER_ID, USER_NAME, DOMAIN_NAME, DISPLAY_NAME, ENABLED, FIXED) values 
  ('3ab9a272-8803-4a2c-85f1-95d9916c9f4c','scheduledupdates','SPOTFIRESYSTEM', 'Scheduled Updates System Account', true, true);
insert into GROUP_MEMBERS (GROUP_ID, MEMBER_USER_ID) values 
...
insert into USERS (USER_ID, USER_NAME, DOMAIN_NAME, DISPLAY_NAME, ENABLED, FIXED) values 
  ('2e738d87-8a69-4e08-b899-ed30acb2ad9c','sbdfcache','SPOTFIRESYSTEM', 'SBDF Cache System Account', true, true);
insert into GROUP_MEMBERS (GROUP_ID, MEMBER_USER_ID) values 
  ('5a544e10-f305-408b-ae0c-a602eec4ed4f', '2e738d87-8a69-4e08-b899-ed30acb2ad9c');
insert into USERS (USER_ID, USER_NAME, DOMAIN_NAME, DISPLAY_NAME, ENABLED, FIXED) values 
  ('341b1e0c-6943-4292-b96a-60de220c0186','monitoring','SPOTFIRESYSTEM', 'Monitoring System Account', true, true);
insert into GROUP_MEMBERS (GROUP_ID, MEMBER_USER_ID) values 
  ('5a544e10-f305-408b-ae0c-a602eec4ed4f', '341b1e0c-6943-4292-b96a-60de220c0186');
insert into USERS (USER_ID, USER_NAME, DOMAIN_NAME, DISPLAY_NAME, ENABLED, FIXED) values 
  ('ba65162e-4958-4fa8-a744-87e003770944','automationservices','SPOTFIRESYSTEM', 'Automation Services System Account', true, true);
insert into GROUP_MEMBERS (GROUP_ID, MEMBER_USER_ID) values 
